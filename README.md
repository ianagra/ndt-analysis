...
Repositório oficial da implementação da metodologia proposta no artigo **"Diagnóstico de QoS em Redes a partir de Análise conjunta de Sobrevivência e Mudanças Estatísticas em Séries Temporais de Desempenho"**, submetido ao **XXIV Workshop em Desempenho de Sistemas Computacionais e de Comunicação (WPerformance) 2025**.
...
### Clone o repositório:
   ...
   ```bash
   git clone https://github.com/ianagra/ndt-analysis.git
   cd ndt-analysis
   ```
